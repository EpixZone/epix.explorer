    ...
    <div class="bg-base-100 px-4 pt-3 pb-4 rounded mb-4 shadow">
        ...
        <div class="grid grid-flow-col auto-cols-max gap-4 overflow-hidden">
            <div class="join w-full border border-primary">
                ...
                <button class="join-item modern-button px-4 py-2" @click="myContracts()">{{ $t('cosmwasm.btn_query') }}</button>
            </div>
            <div>
        ...
        <div class="overflow-x-auto">
            ...
            <div class="flex justify-between">
                ...
                <label for="wasm_store_code" class="modern-button my-5 px-4 py-2" @click="dialog.open('wasm_store_code', {})">{{ $t('cosmwasm.btn_up_sc') }}</label>
            </div>
        </div>
    </div>
</template>
